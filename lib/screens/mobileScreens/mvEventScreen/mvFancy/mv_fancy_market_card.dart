...
class FancyMarketCard extends StatefulWidget {
  const FancyMarketCard({super.key, required this.fancyMarketData, this.favStakeData});

  final FavStakeData? favStakeData;
  final FancyMarketData fancyMarketData;

  @override
  State<FancyMarketCard> createState() => _FancyMarketCardState();
}

class _FancyMarketCardState extends State<FancyMarketCard> {
