...
class MMMvThreeSelectionFancyMarketCard extends StatefulWidget {
  const MMMvThreeSelectionFancyMarketCard({super.key, required this.fancyMarketData, this.favStakeData});
  final FavStakeData? favStakeData;
  final MMFancyMarketData fancyMarketData;

  @override
  State<MMMvThreeSelectionFancyMarketCard> createState() => _MMMvThreeSelectionFancyMarketCardState();
}

class _MMMvThreeSelectionFancyMarketCardState extends State<MMMvThreeSelectionFancyMarketCard> {
