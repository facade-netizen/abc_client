...
Future<dynamic> showMvCgAddMoneyForCasinoMenuDialog(BuildContext context) {
  return showDialog(
    ...
    builder: (BuildContext ctxt) {
      return BlocBuilder<FetchUserAccountDetailsBloc, FetchUserAccountDetailsState>(
        builder: (context, ucs) {
          return ucs is FetchUserAccountDetailsSuccess
              ? ShowMvCgAddMoneyForCasinoMenuDialogBody(
...
class ShowMvCgAddMoneyForCasinoMenuDialogBody extends StatefulWidget {
  const ShowMvCgAddMoneyForCasinoMenuDialogBody({super.key, required this.userDetails});

  final UserAccountDetails? userDetails;
  @override
  State<ShowMvCgAddMoneyForCasinoMenuDialogBody> createState() => _ShowMvCgAddMoneyForCasinoMenuDialogBodyState();
}

class _ShowMvCgAddMoneyForCasinoMenuDialogBodyState extends State<ShowMvCgAddMoneyForCasinoMenuDialogBody> {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            "Main Balance",
                            style: TextStyle(color: highlightText),
                          ),
                          Text(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            height: 70,
                            width: 60,
                            decoration: BoxDecoration(border: Border(right: BorderSide(color: grey))),
                            child: Center(
                              child: Text(
                                "0",
                          ...
                          Container(
                            height: 70,
                            width: 60,
                            decoration: BoxDecoration(border: Border(left: BorderSide(color: grey))),
                            child: Center(
                              child: Text(
                                "Max",
                                style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: blncNameBox),
