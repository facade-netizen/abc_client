...
Future<dynamic> betRadarViewTabMenu(BuildContext context) {
  return showDialog(
    ...
    builder: (BuildContext ctxt) {
      return BlocBuilder<FetchUserAccountDetailsBloc, FetchUserAccountDetailsState>(
        builder: (context, ucs) {
          ...
          return BetRadarTabMenuViewBody(userDetails: userDetails);
        },
      );
    },
  );
...
class BetRadarTabMenuViewBody extends StatefulWidget {
  const BetRadarTabMenuViewBody({super.key, this.userDetails});
  final UserAccountDetails? userDetails;
  @override
  State<BetRadarTabMenuViewBody> createState() => _BetRadarTabMenuViewBodyState();
}

class _BetRadarTabMenuViewBodyState extends State<BetRadarTabMenuViewBody> {
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          width: tfw / 2 - 16,
                          child: BalanceCard(title: "Main Balance", balance: mainBalance.toStringAsFixed(2)),
                        ),
                        const VerticalDivider(color: darkGreen, width: 1, thickness: 1),
                        SizedBox(
                          width: tfw / 2 - 16,
                          child: BalanceCard(title: "Royal gaming Balance", balance: casinoBalance.toStringAsFixed(2), type: 1),
                        ),
                      ],
                    ),
                  ),
            ...
            Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    CancelCTAButton(isDisabled: isProcessing, width: tfw / 2 - 8),
                    CustomCTAButton(
