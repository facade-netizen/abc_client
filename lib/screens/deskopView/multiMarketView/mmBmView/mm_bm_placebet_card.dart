...
class MmBMPlaceBetCard extends StatefulWidget {
  const MmBMPlaceBetCard({
    super.key,
    this.cancel,
    required this.unit,
    required this.price,
  ...
  @override
  State<MmBMPlaceBetCard> createState() => _MmBMPlaceBetCardState();
}

class _MmBMPlaceBetCardState extends State<MmBMPlaceBetCard> {
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text(widget.price, style: TextStyle(color: black, fontSize: 13))),
                                ),
                                SizedBox(width: 8),
