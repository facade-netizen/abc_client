...
class MmFancyPlaceBetCard extends StatefulWidget {
  const MmFancyPlaceBetCard({
    super.key,
    this.cancel,
    required this.unit,
    required this.price,
  ...
  @override
  State<MmFancyPlaceBetCard> createState() => _MmFancyPlaceBetCardState();
}

class _MmFancyPlaceBetCardState extends State<MmFancyPlaceBetCard> {
                            ...
                            children: [
                              ...
                              BlocBuilder<UserAuthChangesBloc, UserAuthChangesState>(
                                builder: (context, ucs) {
                                  ...
                                  return BlocBuilder<SignalRMMFancyDataBloc, SignalRMMFancyDataState>(
                                    builder: (context, frd) {
                                      MMFancyRunner? runner;

                                      if (frd is SignalRMMFancyDataSuccess) {
                                        final market =
                                            frd.fancy.values.where((m) => m.marketId == widget.fancyMarketData.marketId && m.eventId == widget.fancyMarketData.eventId).toList();
